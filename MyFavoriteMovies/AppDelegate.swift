...
//  MyFavoriteMovies
//
//  Created by Abdulrahman on 10/12/2018.
...
extension AppDelegate {
    func tmdbURLFromParameters(_ parameters: [String: AnyObject], withPathExtension: String? = nil) -> URL {
        ...
        componets.scheme = Constants.TMDB.Scheme
        componets.host = Constants.TMDB.Host
        componets.path = Constants.TMDB.Path + (withPathExtension ?? "")
